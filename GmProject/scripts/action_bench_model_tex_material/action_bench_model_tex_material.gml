/// action_bench_model_tex_material(resource)
/// @arg resource
/// @desc Sets the character skin of the workbench settings.

function action_bench_model_tex_material(res)
{
	var fn = "";
	...
	else
	{
		...
		history_set_res(action_bench_model_tex_material, fn, bench_settings.model_tex_material, res)
	}
